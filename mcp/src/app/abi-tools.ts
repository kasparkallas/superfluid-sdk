...
const contractAbis = {
  ...
  superToken: {
    abi: superTokenAbi,
    names: ["SuperToken"],
    tags: ["beginner-friendly", "ERC-20", "Pure Super Token", "Native Asset Super Token", "Wrapper Super Token", "wrap/unwrap", "upgrade/downgrade", "real-time balance"]
  },
  // Protocol contracts
  cfa: {
    abi: cfaAbi,
...
const allValidContractNames = Object.values(contractAbis).flatMap(contract => contract.names).map(name => name.toLowerCase()) as [string, ...string[]];

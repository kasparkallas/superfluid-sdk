...
const SUPERFLUID_RESOURCES: Resource[] = [
  ...
  // SDKs and Libraries
  {
    ...
    category: "sdk",
    description: "Modern TypeScript developer toolkit for Superfluid Protocol. Built on wagmi/viem with zero runtime dependencies, full type safety, and tree-shakeable exports",
  ...
  },
  {
    ...
    category: "sdk",
    description: "Legacy Redux SDK built on top of SDK-core and RTK Query for state management in Superfluid applications",
...

  {
    ...
    useCases: [
      "View Superfluid Protocol activity from bird's eye view"
    ]
  },
  ...
  // Code and Examples
  {
    ...
    category: "code",
    description: "Core code repository containing Superfluid protocol smart contracts, subgraph, automation contracts, and related infrastructure",
  ...
  },
  {
    ...
    useCases: [
      "Claim SUP governance tokens",
      "Check eligibility for SUP tokens",

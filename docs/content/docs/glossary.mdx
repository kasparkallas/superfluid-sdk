...
> **Important**: CFA functions cannot be called directly on the agreement contract. All CFA operations must go through the Host contract using encoded calls or preferably through the CFA Forwarder.
...
> **Important**: GDA functions cannot be called directly on the agreement contract. All GDA operations must go through the Host contract using encoded calls or preferably through the GDA Forwarder.
...
> **Important**: IDA functions cannot be called directly on the agreement contract. All IDA operations must go through the Host contract using encoded calls.

...
```ts twoslash
import { superTokenAddress } from "@superfluid-finance/sdk"
import { mainnet } from "viem/chains"

// Get specific Super Token addresses
const usdcx = superTokenAddress[mainnet.id]["USDCx"]
const daix = superTokenAddress[mainnet.id]["DAIx"]
const ethx = superTokenAddress[mainnet.id]["ETHx"]
```

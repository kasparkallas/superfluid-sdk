...
The GDA Pool emits several events that can be monitored:

- **UnitsUpdated**: When member units are changed
- **DistributionClaimed**: When a member claims tokens
- **AdminChanged**: When pool admin is transferred

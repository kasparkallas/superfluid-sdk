...
- `StrategySet` - Emitted when a strategy is configured
- `StrategyRemoved` - Emitted when a strategy is removed
- `Wrapped` - Emitted when tokens are wrapped
- `WrapFailed` - Emitted when a wrap attempt fails

...
- `FlowScheduleCreated` - Emitted when a new schedule is created
- `FlowScheduleDeleted` - Emitted when a schedule is cancelled
- `FlowScheduleStarted` - Emitted when a scheduled flow starts
- `FlowScheduleEnded` - Emitted when a scheduled flow ends
- `CreateScheduleFailed` - Emitted when schedule creation fails

...
- `VestingScheduleCreated` - Emitted when a new schedule is created
- `VestingScheduleUpdated` - Emitted when a schedule is updated
- `VestingScheduleDeleted` - Emitted when a schedule is terminated
- `VestingCliffExecuted` - Emitted when cliff payment is made
- `VestingEndExecuted` - Emitted when vesting completes

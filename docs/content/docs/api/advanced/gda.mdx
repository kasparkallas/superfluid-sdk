...
- `PoolConnectionUpdated` - Emitted when a member connects/disconnects
- `MemberUnitsUpdated` - Emitted when member units change
- `FlowDistributionUpdated` - Emitted when distribution flow changes

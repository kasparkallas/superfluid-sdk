...
- `IndexDistributionClaimed` - Emitted when distributions are claimed
- `IndexUpdated` - Emitted when an index is updated
- `IndexSubscribed` - Emitted when a subscription is created
- `IndexUnsubscribed` - Emitted when a subscription is deleted
- `SubscriptionApproved` - Emitted when a subscription is approved
- `SubscriptionDistributionClaimed` - Emitted when a subscriber claims
- `SubscriptionUnitsUpdated` - Emitted when subscription units change

...
- `FlowUpdated` - Emitted when a flow is created or updated
- `FlowUpdatedExtension` - Extended flow update information
- `FlowOperatorUpdated` - Emitted when operator permissions change

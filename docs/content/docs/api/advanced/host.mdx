...
- `AgreementClassRegistered` - Emitted when a new agreement type is registered
- `AppRegistered` - Emitted when a Super App is registered
- `GovernanceReplaced` - Emitted when governance is updated
